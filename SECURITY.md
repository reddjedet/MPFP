...
4. **Persistencia Atómica y Durabilidad SQLite WAL:** La base de datos opera bajo motor SQLite con modo Write-Ahead Logging (`PRAGMA journal_mode=WAL`), transacciones inmediatas y cerrojos reentrantes para prevenir corrupción o sobrescrituras destructivas ante cortes abruptos de proceso.
